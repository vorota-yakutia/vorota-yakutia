    ...
    <div class="hero-content text-center">
      <div class="max-w-xl">
        <h1 class="text-4xl text-white md:text-5xl font-bold mb-6">
          Алютех - Ворота в Якутске: Купить по выгодной цене
        </h1>
        <p class="text-white md:text-lg mb-6">
          ...
          ваш надежный партнер в сфере бытовых и промышленных решений. Узнайте цены на наши услуги уже сегодня!
        </p>
...
const pageTitle = 'Купить автоматические ворота в Якутске | Цены от Алютех';
const pageDescription = 'Алютех - ведущий поставщик и установщик автоматических ворот, роллетных систем и шлагбаумов в Якутске. Узнайте цены и купите качественные ворота от официального представителя.';
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        url: siteUrl,
        priceRange: '₽₽₽',
        description: 'Профессиональная установка и обслуживание автоматических ворот, роллетных систем и шлагбаумов в Якутске. Официальный представитель Алютех. Выгодные цены на покупку и монтаж.',
      }),
    },
  ],
});
