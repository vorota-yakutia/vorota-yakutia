...
useSeoMeta({
  title: 'Купить ворота в Якутске | Автоматические, секционные, гаражные ворота, рольставни',
  ogTitle: 'Купить ворота в Якутске | Автоматические, секционные, гаражные ворота, рольставни',
  description: 'Купить ворота в Якутске от официального дилера Алютех. Автоматические, секционные, гаражные, откатные ворота, рольставни и роллеты. Монтаж и обслуживание. Низкие цены, гарантия 2 года.',
  ogDescription: 'Купить ворота в Якутске от официального дилера Алютех. Автоматические, секционные, гаражные, откатные ворота, рольставни и роллеты. Монтаж и обслуживание. Низкие цены, гарантия 2 года.',
  ogSiteName: siteName,
  ogImage: ogBanner,
  twitterCard: 'summary_large_image',
  twitterTitle: 'Купить ворота в Якутске | Автоматические, секционные, гаражные ворота, рольставни',
  twitterDescription: 'Купить ворота в Якутске от официального дилера Алютех. Автоматические, секционные, гаражные, откатные ворота, рольставни и роллеты. Монтаж и обслуживание.',
  twitterImage: ogBanner,
});

useHead({
  meta: [
    { name: 'keywords', content: 'ворота, автоматические ворота, рольставни, роллеты, откатные ворота, ворота якутск, монтаж ворот, секционные ворота, гаражные ворота' },
  ],
  htmlAttrs: {
    lang: 'ru',
  },
      ...
      children: JSON.stringify([
        {
          ...
          '@type': 'WebSite',
          name: 'ТМК - Купить автоматические ворота в Якутске',
          url: 'https://www.vorota-yakutia.ru/',
        },
        {
          '@context': 'https://schema.org',
          '@type': 'LocalBusiness',
          name: 'ТМК - Автоматические ворота в Якутске',
          ...
          url: siteUrl,
          priceRange: '₽₽₽',
          description: 'Купить ворота в Якутске от официального дилера Алютех. Продажа, установка и обслуживание автоматических ворот, секционных ворот, гаражных ворот, откатных ворот, рольставней и роллет. Гарантия 2 года, низкие цены, сертифицированные монтажники.',
          hasOfferCatalog: {
            '@type': 'OfferCatalog',
            name: 'Продукция Алютех в Якутске',
            itemListElement: [
              {
                '@type': 'OfferCatalog',
